...
class PromptTracer:
    ...
    def add_stage(self, stage: str, system_prompt: str, user_prompt: str, raw_response: str, parsed_response: Any, token_usage: Dict[str, int] = None, *, model: str = "gemini-2.5-flash-lite"):
